...
export default function QuestValentineView({ data }: QuestValentineViewProps) {
    ...
    if (yesPressed) {
        return (
            <div className="flex flex-col items-center justify-center h-screen bg-[#050505] text-center p-6 overflow-hidden relative font-geist">
                ...
                {/* Music Player (If musicUrl exists) */}
                {data.musicUrl && (
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-[#050505] text-center p-6 overflow-hidden relative font-geist">
            {/* Liquid Background */}
